/**
 * @file loop plugin — lifecycle (onStart/onStop) skeleton.
 */

/**
 * Starts the loop plugin's managed resource.
 *
...
/**
 * Stops the loop plugin's managed resource. Reads its handle from the module WeakMap via ctx.global.
 *
