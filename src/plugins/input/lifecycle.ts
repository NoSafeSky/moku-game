/**
 * @file input plugin — lifecycle (onStart/onStop) skeleton.
 */

/**
 * Starts the input plugin's managed resource.
 *
...
/**
 * Stops the input plugin's managed resource. Reads its handle from the module WeakMap via ctx.global.
 *
